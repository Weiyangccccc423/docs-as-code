...
def _artifact_smoke_consumer_implementation_routing_ok(payload: dict[str, object] | None) -> bool:
    ...
    return (
        ...
        and implementation_routing.get("implementation_run_preview_ok") is True
        and implementation_routing.get("run_previewed") is True
        and implementation_routing.get("run_preview_skipped") is True
        and implementation_routing.get("run_preview_skip_code") == "advance_apply_not_applied"
        and implementation_routing.get("run_preview_blocked_by") == "implementation_advance_apply"
        and implementation_routing.get("run_required_advance_applied") is False
        and implementation_routing.get("run_handoff_ready") is False
        and implementation_routing.get("run_status") == ""
        and implementation_routing.get("run_task_id") == ""
        and implementation_routing.get("run_snapshot") == {}
        and implementation_routing.get("run_next_action") == {}
