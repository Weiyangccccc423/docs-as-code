...
| Product is structured and design is needed | `designing-system-architecture`, then `designing-api-contracts`, then `designing-frontend-modules` when frontend docs are in scope |
