...
4. Read `references/architecture-quality-checklist.md`.
5. Replace scaffold placeholders in architecture files with product-derived content.
6. Identify actors, systems, and external services.
7. Define containers without committing to unnecessary internal classes.
8. Write measurable quality scenarios for important availability, performance, security, observability, maintainability, deployment, or operability claims.
9. Document runtime success paths, failure paths, tradeoffs, risks, and verification hooks for high-risk quality scenarios.
10. Record cross-module decisions as ADRs.
11. Link every architecture claim to product, API, backend/frontend, test, decision, or unresolved sources.
