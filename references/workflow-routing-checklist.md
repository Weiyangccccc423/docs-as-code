...
- During design, is `work_stage` followed in authoring, integration, threat-review, machine-review, reliability-review, review order so authority signoff cannot bypass deterministic checks?
