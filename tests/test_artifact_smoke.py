...
class ArtifactSmokeTest(unittest.TestCase):
    ...
    def test_artifact_smoke_unpacks_and_runs_checks_from_exported_pack(self) -> None:
        ...
        self.assertTrue(payload["fresh_target_init"]["target_local_short_cli"]["ok"])
        ...
        self.assertIn("fresh_target_dac_help", step_ids)
        self.assertIn("fresh_target_dac_status", step_ids)
        self.assertIn("fresh_target_dac_next", step_ids)
        self.assertIn("fresh_target_dac_verify", step_ids)
